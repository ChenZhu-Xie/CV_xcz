...
\fancyfoot[L]{\color{color-detail} {\color{\theme} \mysection{Education}} $|$ {\color{\theme} \mysection{Research}} $|$ \mysection{Activities} $|$ \mysection{Publications} $|$ \mysection{Focus} $|$ \mysection{Awards} $|$ \mysection{Projects} $|$ \mysection{History}}
\import{sections/}{scientific_activities.tex}
\vspace{-1.3cm}
\import{sections/}{publications.tex}
\import{sections/}{academic_focus.tex}
\fancyfoot[L]{\color{color-detail} \mysection{Education} $|$ \mysection{Research} $|$ {\color{\theme} \mysection{Activities}} $|$ {\color{\theme} \mysection{Publications}} $|$ {\color{\theme} \mysection{Focus}} $|$ \mysection{Awards} $|$ \mysection{Projects} $|$ \mysection{History}}
...
\import{sections/}{personal_history.tex}
\fancyfoot[L]{\color{color-detail} \mysection{Education} $|$ \mysection{Research} $|$ \mysection{Activities} $|$ \mysection{Publications} $|$ \mysection{Focus} $|$ \mysection{Awards} $|$ {\color{\theme} \mysection{Projects}} $|$ {\color{\theme} \mysection{History}}}
