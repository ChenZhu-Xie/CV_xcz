...
\\
\begin{tabularx}{\linewidth}{@{\extracolsep{\fill}} lcr}
	2023.06 \hspace{1.4em} {\color{color-detail} Involving $\bar{\bar{\bar{\chi}}}^{(2)}_{\omega}$ anisotropy $\Rightarrow$} & \phantom{} & \textbf{Vector} non-uniform analytic linear \& nonlinear Fourier crystal optics \href{https://github.com/ChenZhu-Xie/PhD_academia/blob/master/1__Group_Meeting/6.2__\%E7\%BB\%B4\%E7\%89\%B9\%E6\%A0\%B9\%E6\%96\%AF\%E5\%9D\%A6_\%E2\%86\%90_Python\%2BVisio\%2BBookxNote_Pro\%2BLabView\%2BLatex__3.0_year_-_2023.6.9.pdf}{\raisebox{-0.05\height}\faGithub}
\end{tabularx}
\\
\begin{tabularx}{\linewidth}{@{\extracolsep{\fill}} lcr}
